...
/**
 * Class representing ExtendedOrganizationDetailsTorg2Type
 *
 * 
 * XSD Type: ExtendedOrganizationDetails_Torg2
 */
class ExtendedOrganizationDetailsTorg2Type extends ExtendedOrganizationDetailsManualFillingTorg2Type
{
