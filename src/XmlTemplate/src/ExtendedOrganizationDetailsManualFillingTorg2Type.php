...
/**
 * Class representing ExtendedOrganizationDetailsManualFillingTorg2Type
 *
 * 
 * XSD Type: ExtendedOrganizationDetails_ManualFilling_Torg2
 */
class ExtendedOrganizationDetailsManualFillingTorg2Type
{
