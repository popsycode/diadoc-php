...
class ProformaInvoiceTableType
{
    ...
    /**
     * @property \AgentSIB\Diadoc\XmlTemplate\ProformaInvoiceItemType[] $proformaInvoiceItem
     */
    ...
    /**
     * @property \AgentSIB\Diadoc\XmlTemplate\VatType $vatTotal
     */
     ...
     *
     * @return self
     * @param \AgentSIB\Diadoc\XmlTemplate\ProformaInvoiceItemType $proformaInvoiceItem
     */
    public function addToProformaInvoiceItem(\AgentSIB\Diadoc\XmlTemplate\ProformaInvoiceItemType $proformaInvoiceItem)
    {
     ...
     *
     * @return \AgentSIB\Diadoc\XmlTemplate\ProformaInvoiceItemType[]
     */
     ...
     * Sets a new vatTotal
     *
     * @param \AgentSIB\Diadoc\XmlTemplate\VatType $vatTotal
     * @return self
     */
    public function setVatTotal(\AgentSIB\Diadoc\XmlTemplate\VatType $vatTotal)
    {
