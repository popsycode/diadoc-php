...
/**
 * Protobuf message :
 * AgentSIB.Diadoc.Api.Proto.Employees.Subscriptions.EmployeeSubscriptions
 */
class EmployeeSubscriptions extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \AgentSIB\Diadoc\Api\Proto\Employees\Subscriptions\EmployeeSubscriptions) {
